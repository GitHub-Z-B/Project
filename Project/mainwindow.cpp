    ...
    , ui(new Ui::MainWindow)
{
    ...
    installWindowAgent();
    QString usernameManagementText = QStringLiteral("用户\n管理");
    ui->toolButton_4->setText(usernameManagementText);
    ...
    ui->page_1->init();
    ui->page_5->init();
    connect(this,&MainWindow::ToJLConfig,ui->page_1,&TaskWidget::ToJLConfig);
}
...
void MainWindow::installWindowAgent()
{
    ...
    auto menuBar = [this]() {
        ...
        auto action3 = new QAction(QIcon(":/QuestionnaireManagement.png"), "激励配置", menuBar);
...
void MainWindow::on_toolButton_4_clicked()
{
    ...
    ui->stackedWidget->setCurrentIndex(3);
    ui->page_4->initUserList(userinitflag);
    userinitflag=true;
